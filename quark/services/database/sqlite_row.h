...
QKAPI int QKSqliteRowGetColumnCount(QKSqliteRow *instance, int *resultCode);

QKAPI QKSqliteColumn *QKSqliteRowGetColumnByName(QKSqliteRow *instance,
                                                 QKString *name,
                                                 int *resultCode);

QKAPI QKSqliteColumn *QKSqliteRowGetColumnByIndex(QKSqliteRow *instance,
                                                  int index, int *resultCode);
...
public:
  ...
  static QKSqliteRow *
  MTSqliteRowToQKSqliteRow(std::shared_ptr<quark::MTSqliteRow> mtSqlRow);
