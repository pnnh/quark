...
QKSqliteCommand* quark::MTSqliteCommand::MTSqliteCommandToQKSqliteCommand(
    std::unique_ptr<quark::MTSqliteCommand>&& instance)
{
...
int QKSqliteCommandBindInt(QKSqliteCommand* instance, QKString* name, int value, int* resultCode)
{
...
int QKSqliteCommandBindString(QKSqliteCommand* instance, QKString* name, QKString* value, int* resultCode)
{
    auto mtCmd = static_cast<std::unique_ptr<quark::MTSqliteCommand>*>(instance->mtSqliteCommand);
    if (resultCode != nullptr) *resultCode = QKResultOk;
...
QKSqliteResult* QKSqliteCommandRun(QKSqliteCommand* instance, int* resultCode)
{
    auto mtCmd = static_cast<std::unique_ptr<quark::MTSqliteCommand>*>(instance->mtSqliteCommand);
    auto mtResult = (*mtCmd)->Run();
    auto qkResult = quark::MTSqliteResult::MTSqliteResultToQKSqliteResult(mtResult);
    if (resultCode != nullptr) *resultCode = QKResultOk;
    return qkResult;
}

int QKSqliteCommandClose(QKSqliteCommand* instance, int* resultCode)
{
    auto mtCmd = static_cast<std::unique_ptr<quark::MTSqliteCommand>*>(instance->mtSqliteCommand);
    delete mtCmd;
    if (resultCode != nullptr) *resultCode = QKResultOk;
