...
QKSqliteRow* quark::MTSqliteRow::MTSqliteRowToQKSqliteRow(std::shared_ptr<quark::MTSqliteRow> mtSqlRow)
{
...
QKSqliteColumn* QKSqliteRowGetColumnByName(QKSqliteRow* instance, QKString* name, int* resultCode)
{
    ...
    auto qkCol = quark::MTSqliteColumn::MTSqliteColumnToQKSqliteColumn(column);
    if (resultCode != nullptr) *resultCode = QKResultOk;
    return qkCol;
}

int QKSqliteRowGetColumnCount(QKSqliteRow* instance, int* resultCode)
{
    auto mtSqlRow = static_cast<std::shared_ptr<quark::MTSqliteRow>*>(instance->mtSqlRow);
    if (resultCode != nullptr) *resultCode = QKResultOk;
...
QKSqliteColumn* QKSqliteRowGetColumnByIndex(QKSqliteRow* instance, int index, int* resultCode)
{
    auto mtSqlRow = static_cast<std::shared_ptr<quark::MTSqliteRow>*>(instance->mtSqlRow);
